...
A snippet template is also included with this project if you are using vscode. Just type \`docs\` in any \`.md\` or \`.mdx\` file and you will see a suggestion for a template named \`docs\`. Most of the frontmatter properties are commented. Uncomment them by removing \`#\`. For date and time we use [standard date-time string format](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Date#date_time_string_format).`,s={title:"Pages",author:"saumilthecode",draft:!1,tags:[],hide_breadcrumbs:!1,hide_toc:!1,hide_sidenav:!1,max_width:!1},a={type:"content",filePath:"/Users/tkrobot/Library/Mobile Documents/com~apple~CloudDocs/Documents/BBSSHack-Revamped/src/content/docs/Guides/pages.mdx",rawData:void 0};export{a as _internal,o as body,t as collection,s as data,e as id,n as slug};
